...
public class VectorRectangle extends VectorQuadrilateral {
    /**
     ...
     * @param bottomRight
     */
    public VectorRectangle(String id, Color colour, boolean isFilled, Point topLeft, Point bottomLeft, Point topRight, Point bottomRight) {
